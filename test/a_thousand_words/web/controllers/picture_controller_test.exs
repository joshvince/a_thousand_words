defmodule AThousandWords.Web.PictureControllerTest do
  ...
  @create_attrs %{year: 1960, name: "My Childhood Home", description: "Where I grew up", 
                  location: @geoJSON_point, image: TestImg.base64_img_params()}
  @update_attrs %{year: 1961, location: @geoJSON_point, image: TestImg.base64_img_params()}
